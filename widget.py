...
class namewidget():
    ...
    def update_color(self,color):
        self.line.setStyleSheet("QLabel{background-color: %s}" %color)from PyQt5 import QtWidgets
from PyQt5.QtWidgets import QLabel, QHBoxLayout
...
class namewidget():
    ...
    def update_color_text(self,color, color_background, size):
        self.name.setStyleSheet("QLabel{{color: {0};  background-color: {1}; font: {0}pt 'Oswald';}}".format(color, color_background,size))
