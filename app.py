...
class MainWindow(QtWidgets.QMainWindow):
        global lis,packet,simp, size, curstate, width, ser
...
#-----------------------------------------------------------------------------------
        ...
        def update(self):
                ...
                self.graphTilt_XY1.update(self.i,[ abs(self.tiltXValue),abs(self.tiltYValue)])
