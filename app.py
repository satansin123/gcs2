...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        def buttonfunc(name,fontsize):
                ...
                if name=="Telemetry":
                        self.button_name.clicked.connect(self.telemetry_button)
                if name=="Calibration":
                        self.button_name.clicked.connect(self.calibration_button)
                if name=="Set Time UTC":
                        self.button_name.clicked.connect(self.set_time_utc_button)
                if name=="Set Time GPS":
                        self.button_name.clicked.connect(self.set_time_gps_button)
                if name=="Simulation-Enable":
                        self.button_name.clicked.connect(self.simulation_enabled_button)
                if name=="Simulation-Activate":
                        self.button_name.clicked.connect(self.simulation_activate_button)
...
#-------graph voltage starts---------------------------------------------------------------------------------------------------------
        ...
        graphVoltage_Layout.addWidget(namewidget().nameline("Voltage",int((7/1980)*self.w),int((25/880)*self.h),int((10/1980)*self.w)))
